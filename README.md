...
The above chart (results.png) is a bar graph that shows the average execution time (in ms) for each summation method and thread count, providing a clear comparison of performance scalability.
